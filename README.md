# <img src="images/purple-fire.gif" alt="drawing" width="70"/> Masters of Elixir <img src="images/purple-fire.gif" alt="drawing" width="70"/>
...
- [ElixirMEX :es:](https://t.me/ElixirMEX) - Elixir user group in Mexico.
...
- [Pattern Matching, Mark Ericksen :us: :free:](https://thinkingelixir.com/available-courses/pattern-matching.html) - A free course teaching the fundamentals of pattern matching in Elixir, designed to help developers transitioning to functional programming understand this powerful language feature and create clearer, more elegant code.
- [Code Flow, Mark Ericksen :us: :free:](https://thinkingelixir.com/available-courses/code-flow/index.html) - A free course focusing on changing how programmers think about control flow in Elixir, covering pattern matching, immutability, recursion, and alternative approaches to traditional programming techniques through a functional programming lens.
...
- [Advanced Functional Programming with Elixir: Model Behavior, Manage Complexity, and Maximize Maintainability, Joseph Koski :us:](https://pragprog.com/titles/jkelixir/advanced-functional-programming-with-elixir/) - Advanced functional programming concepts with production-ready Elixir and domain-driven design techniques.
...
- [Mastering BEAM: The Core Architecture of Erlang and Elixir, David I Huang :us:](https://www.amazon.com.mx/Mastering-BEAM-Architecture-Erlang-Elixir/dp/B0FF34CTJ7) - A comprehensive technical guide exploring the core architectural principles of the BEAM virtual machine, providing deep insights into the runtime environment that powers Erlang and Elixir.
...
- [Elixir Companies :us:](https://elixir-companies.com) - Directory of companies using Elixir, often with job listings.
